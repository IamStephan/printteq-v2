      ...
      <div className="grid gap-10 mx-auto lg:grid-cols-2 lg:max-w-screen-lg">
        <div className="grid sm:grid-cols-3">
          ...
          <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
            <p className="text-lg font-bold">Carel Pieterse</p>
            <p className="mb-4 text-xs text-gray-800">Owner | Founder</p>
        ...
        <div className="grid sm:grid-cols-3">
          ...
          <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
            <p className="text-lg font-bold">Tyron Cox</p>
            <p className="mb-4 text-xs text-gray-800">Design Manager</p>
